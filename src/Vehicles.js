...
import insr from "./images/insurance.jpg";
import Services from "./Services";
import vehiclecover from "./images/vehiclecover.jpg";

function Home() {
  return (
    <div className="home">
      <div className="home__container">
        <img className="home__image" src={vehiclecover} alt="" />

        <h1 className="vehicle__cover">Click Picks Garage</h1>
        <div className="components">
          <div className="left__part">
            <div className="home__row">
              <Services
                id="12321341"
                title="Ride Your Own Car"
                image={car}
              />

              <Services
                id="49538094"
                title="Gift Yourself a Bike"
                image={bike}
              />
            </div>
            ...
            <div className="home__row">
              <Services
                id="4903850"
                title="Buy or Sell your Vehicles"
                image={buysell}
              />

              <Services
                id="23445930"
                title="Take a Shade under Insurance"
                image={insr}
              />
            </div>
          </div>
          <div className="right__part__vehicles" >
            <form >
              <div className="form-row">
                <div className="radio my-5 " >
                  <input type="radio" name="choice" id="choice "checked="checked" /><span className="text" style={{color:"black"}} > Round Trip</span>
                  <span className="mx-5">
                  <input type="radio" name="choice" id="choice" /><span className="text" style={{color:"black"}}  >One Way</span>
                  </span>
                  <span>
                  <input type="radio" name="choice" id="choice" /><span className="text" style={{color:"black"}} >Multi City</span>
                  <br/>
                  <br/>
                  </span>
                </div>
                <div className="dests1" >
                  ...
                  <span className="text mx-2 ms-5 my-3" style={{color:"black"}}>Flying From</span>
                ...
                <div className="dests1">
                  ...
                  <span className="text mx-4 ms-5 my-3" style={{color:"black"}}>Flying To</span>
